<section class="space-y-6">
    <x-modal name="create-team" :show="$errors->isNotEmpty()" focusable>
        <form method="POST" action="{{ route('team.store') }}" class="p-6" x-data="{ submitting: false }" @submit.prevent="submitting = true; $el.submit()">
            @csrf
            ...
            <div class="mt-8 flex justify-end gap-3">
                ...
                <x-primary-button x-bind:disabled="submitting" class="disabled:opacity-20 disabled:cursor-not-allowed">
                    ...
                    <span x-show="submitting">Creating team...</span>
                </x-primary-button>
            </div>
        </form>
    </x-modal>
